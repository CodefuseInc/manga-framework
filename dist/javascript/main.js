...
var _servicesBrowser_utilities = require("./services/browser_utilities");

var appRoot = _servicesBrowser_utilities.appRoot;
var canAppRegisterInBrowser = _servicesBrowser_utilities.canAppRegisterInBrowser;

var watchForUpdates = require("./services/app_cache_manager").watchForUpdates;

var FareInput = _interopRequire(require("./components/fare_input/fare_input.jsx"));

var Instructions = _interopRequire(require("./components/instructions/instructions.jsx"));

var PurchaseOptions = _interopRequire(require("./components/purchase_options/purchase_options.jsx"));

var Footer = _interopRequire(require("./components/footer/footer.jsx"));

var store = _interopRequire(require("./stores/fares"));
    ...
    render: {
      value: function render() {
        return React.createElement(
          ...
          React.createElement(
            "section",
            { className: "fare-calculator" },
            React.createElement(FareInput, null),
            React.createElement(PurchaseOptions, null),
...
if (canAppRegisterInBrowser) {
  render(React.createElement(App, null), appRoot);
}

},{"./components/fare_input/fare_input.jsx":182,"./components/footer/footer.jsx":183,"./components/instructions/instructions.jsx":184,"./components/purchase_options/purchase_options.jsx":185,"./services/app_cache_manager":188,"./services/browser_utilities":189,"./stores/fares":191,"react":170,"react-dom":3,"react-redux":6}],2:[function(require,module,exports){
'use strict';
  ...
  _createClass(CurrencyMaskedInput, [{
    ...
    value: function onChange(evt) {
      ...
      this.setState({ value: value }, function () {
        if (_this.props.onChange) {
          ...
          _this.props.onChange(evt, value);
        }
      });
    }
  }, {
    ...
    value: function render() {
      ...
      return _react2['default'].createElement('input', _extends({
        ref: function () {
          return _this2.value = _this2.state.value;
        },
        type: 'number',
        pattern: '\\d*'
      }, this.props, {
...
},{"../utils/storeShape":8,"react":170}],5:[function(require,module,exports){
'use strict';
...
},{"../utils/shallowEqual":7,"../utils/storeShape":8,"../utils/wrapActionCreators":9,"hoist-non-react-statics":10,"invariant":11,"lodash/isPlainObject":14,"react":170}],6:[function(require,module,exports){
'use strict';
...
},{"./createStore":175,"./utils/warning":177,"lodash/isPlainObject":180}],174:[function(require,module,exports){
"use strict";
...
},{"./applyMiddleware":171,"./bindActionCreators":172,"./combineReducers":173,"./compose":174,"./createStore":175,"./utils/warning":177}],177:[function(require,module,exports){
'use strict';
...
var FARE_UPDATES = _interopRequire(require("../constants/fare_updates"));

var Fares = _interopRequire(require("../stores/fares"));

var updateFareParameters = function (remainingBalance, maxToSpend) {
  Fares.dispatch({
...
module.exports = { updateFareParameters: updateFareParameters };

},{"../constants/fare_updates":186,"../stores/fares":191}],182:[function(require,module,exports){
"use strict";
...
var FareActions = _interopRequire(require("../../actions/fare_actions"));

var CurrencyMaskedInput = _interopRequire(require("react-currency-masked-input"));

var connect = require("react-redux").connect;

var FareInput = exports.FareInput = (function (_Component) {
  function FareInput(_ref) {
    var maxToSpend = _ref.maxToSpend;

    _classCallCheck(this, FareInput);

    _get(Object.getPrototypeOf(FareInput.prototype), "constructor", this).call(this, { maxToSpend: maxToSpend });
    this.state = { maxToSpend: maxToSpend };
  }

  _inherits(FareInput, _Component);

  _createClass(FareInput, {
    setFareParameters: {
      value: function setFareParameters() {
        var remainingBalance = this.refs.balanceInput.value;
        var maxToSpend = this.refs.maxInput.value;

        FareActions.updateFareParameters(remainingBalance, maxToSpend);

        this.setState({ maxToSpend: maxToSpend });
      }
    },
    render: {
      value: function render() {
        ...
        return React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(CurrencyMaskedInput, {
              "aria-labelledby": "remaining-balance",
              name: "remaining",
              ref: "balanceInput",
              onChange: function () {
                return _this.setFareParameters();
              }, required: true, placeholder: "0.00", autofocus: true
            }),
            React.createElement(
              "h3",
              { id: "max-to-spend" },
...
var mapStateToProps = function (_ref) {
  var maxToSpend = _ref.maxToSpend;
  return { maxToSpend: maxToSpend };
};

exports.mapStateToProps = mapStateToProps;
exports["default"] = connect(mapStateToProps)(FareInput);

},{"../../actions/fare_actions":181,"react":170,"react-currency-masked-input":2,"react-redux":6}],183:[function(require,module,exports){
"use strict";
...
var Footer = function () {
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        "a",
        { href: "http://twitter.com/farelyapp", target: "_blank" },
        "@farelyapp"
      ),
      "."
    ),
    React.createElement(
      ...
      React.createElement(
        "a",
        { href: "http://cash.me/$ianmcnally", target: "_blank" },
        "Tip us."
      )
    ),
    React.createElement(
      ...
      React.createElement(
        "p",
        { className: "footer-paragraph footer-solicitation" },
...
var Instructions = function (_ref) {
  var hidden = _ref.hidden;
  return React.createElement(
    "p",
    { className: "instructions", hidden: hidden },
...
var mapStateToProps = function (_ref) {
  var purchaseOptions = _ref.purchaseOptions;
  return { hidden: Boolean(purchaseOptions.length) };
};

exports.mapStateToProps = mapStateToProps;
exports["default"] = connect(mapStateToProps)(Instructions);

},{"react":170,"react-redux":6}],185:[function(require,module,exports){
"use strict";
...
var PurchaseOptions = function (_ref) {
  var purchaseOptions = _ref.purchaseOptions;

  var children = purchaseOptions.map(function (option, i) {
    return React.createElement(
      "li",
      { key: i, className: "purchase-amount" },
      React.createElement(
        "span",
        { className: "amount" },
        option.amount
...
var mapStateToProps = function (_ref) {
  var purchaseOptions = _ref.purchaseOptions;
  return { purchaseOptions: purchaseOptions };
};

exports.mapStateToProps = mapStateToProps;
exports["default"] = connect(mapStateToProps)(PurchaseOptions);

},{"react":170,"react-redux":6}],186:[function(require,module,exports){
"use strict";
...
var confirmReload = function () {
  return confirm("A new version of Farely is available. Launch it?");
}; //eslint-disable-line no-alert

var confirmIfUpdateReady = function () {
...
module.exports = { watchForUpdates: watchForUpdates };
...
var appRoot = document && document.getElementsByTagName("main")[0];

var canAppRegisterInBrowser = Boolean(document);

module.exports = { appRoot: appRoot, canAppRegisterInBrowser: canAppRegisterInBrowser };
...
var RATES = _interopRequire(require("../constants/rates"));

Math.trunc || (Math.trunc = function (value) {
  return value < 0 ? Math.ceil(value) : Math.floor(value);
});

var createFareMultiples = function (max) {
  var maxToSpend = max > RATES.TRANSACTION_MAX ? RATES.TRANSACTION_MAX : max;
  var fareMultiple = 0;
  var fares = [];
...
var getChange = function (cost) {
  return parseInt((cost - Math.trunc(cost)).toFixed(2) * 100);
};

var isValidAmount = function (amountToAdd) {
  return !(getChange(amountToAdd) % 5) && amountToAdd > 0;
};

var amountToAdd = function (fare, balanceLeft) {
  var amount = fare - balanceLeft;
  var bonus = RATES.BONUS_PERCENT * 0.01 + 1;
  var amountWithBonus = amount / bonus;

  // doesn't return amount-bonus (how much to pay) if amount-bonus is < min bonus amount
  var toAdd = amountWithBonus < RATES.BONUS_MIN ? amount : amountWithBonus;

  return toAdd.toFixed(2);
};

module.exports = {
  amountsToAdd: function (balanceLeft, maxToSpend) {
    if (balanceLeft === null || maxToSpend === null) {
      return [];
    }
    var purchases = [];
    var fares = createFareMultiples(maxToSpend);
    for (var i = fares.length - 1; i >= 0; i--) {
      var toAdd = amountToAdd(fares[i], balanceLeft);
...
},{"../constants/rates":187}],191:[function(require,module,exports){
"use strict";
...
var FARE_PARAMETER = require("../constants/fare_updates").FARE_PARAMETER;

var fareService = _interopRequire(require("../services/fare"));
...
module.exports = createStore(function (_x, action) {
  var state = arguments[0] === undefined ? initialState : arguments[0];

  if (action.type === FARE_PARAMETER) {
    var remainingBalance = action.remainingBalance;
    var maxToSpend = action.maxToSpend;
...
},{"../constants/fare_updates":186,"../services/fare":190,"redux":176}]},{},[1]);
